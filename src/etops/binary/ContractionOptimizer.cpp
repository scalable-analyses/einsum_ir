...
void einsum_ir::etops::ContractionOptimizer::init( std::vector< iter_property > * i_iter_space,
...
einsum_ir::etops::err_t einsum_ir::etops::ContractionOptimizer::optimize(){
...
void einsum_ir::etops::ContractionOptimizer::sort_and_fuse_iters(){
...
void einsum_ir::etops::ContractionOptimizer::remove_empty_iters(){
...
void einsum_ir::etops::ContractionOptimizer::find_iters_with_stride( std::vector<iter_property>::iterator & o_iter_left,
...
void einsum_ir::etops::ContractionOptimizer::find_iter_with_dimtype( std::vector<iter_property>::iterator & o_iter,
                                                                     dim_t i_dim_type ){
...
void einsum_ir::etops::ContractionOptimizer::get_size_all_m_n( int64_t & o_size_m,
                                                               int64_t & o_size_n ){
  std::vector<iter_property>::iterator l_it;
  o_size_m = 1;
  o_size_n = 1;
...
void einsum_ir::etops::ContractionOptimizer::set_kernel_targets_heuristic( int64_t * i_potential_kernel_size,
...
einsum_ir::etops::err_t einsum_ir::etops::ContractionOptimizer::set_primitive_iters(){
...
void einsum_ir::etops::ContractionOptimizer::reorder_and_parallelize_iters(){
...
void einsum_ir::etops::ContractionOptimizer::move_iters_until( std::vector<iter_property> * i_dest_iters,
...
void einsum_ir::etops::ContractionOptimizer::split_iter( std::vector<iter_property>::iterator i_iteration,
                                                         int64_t                              i_target_size,
...
int64_t einsum_ir::etops::ContractionOptimizer::find_split( int64_t i_dim_size,
                                                            int64_t i_target_size ){
