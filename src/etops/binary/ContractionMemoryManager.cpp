...
einsum_ir::etops::ContractionMemoryManager::~ContractionMemoryManager() {
...
void einsum_ir::etops::ContractionMemoryManager::alloc_all_memory(){
  if( m_req_thread_mem ){
...
void einsum_ir::etops::ContractionMemoryManager::reserve_thread_memory( int64_t i_size, 
...
char * einsum_ir::etops::ContractionMemoryManager::get_thread_memory( int64_t i_thread_id ){
