...
template < typename T >
void einsum_ir::etops::ContractionBackendScalar::kernel_zero( void const *,
                                                              void       * o_data ) {
  T * l_data = (T *) o_data;
  *l_data = T(0);
}
...
template < typename T >
void einsum_ir::etops::ContractionBackendScalar::kernel_relu( void const *,
                                                              void       * io_data ) {
  T * l_data = (T *) io_data;
...
template < typename T >
void einsum_ir::etops::ContractionBackendScalar::kernel_copy( void const * i_data_src,
                                                              void       * io_data_dst ) {
...
template < typename T_LEFT,
           typename T_RIGHT,
           typename T_OUT >
void einsum_ir::etops::ContractionBackendScalar::kernel_madd( void const * i_left,
                                                              void const * i_right,
                                                              void       * io_out ) {
...
einsum_ir::etops::err_t einsum_ir::etops::ContractionBackendScalar::compile_kernels() {
...
void einsum_ir::etops::ContractionBackendScalar::kernel_first_touch( void const * i_out_aux,
                                                                     void       * io_out ) {
...
void einsum_ir::etops::ContractionBackendScalar::kernel_main( void const * i_left,
                                                              void const * i_right,
                                                              void       * io_out ) {
...
void einsum_ir::etops::ContractionBackendScalar::kernel_last_touch( void const * i_out_aux,
                                                                    void       * io_out ) {
