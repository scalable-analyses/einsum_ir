...
template < typename T >
void einsum_ir::etops::UnaryBackendScalar::kernel_zero( void const *,
                                                        void       * o_data ) {
  T * l_data = (T *) o_data;
  *l_data = T(0);
}
...
template < typename T >
void einsum_ir::etops::UnaryBackendScalar::kernel_relu( void const *,
                                                        void       * io_data ) {
  T * l_data = (T *) io_data;
...
template < typename T >
void einsum_ir::etops::UnaryBackendScalar::kernel_copy( void const * i_data_src,
                                                        void       * io_data_dst ) {
...
einsum_ir::etops::err_t einsum_ir::etops::UnaryBackendScalar::compile_kernels() {
...
void einsum_ir::etops::UnaryBackendScalar::kernel_main( void const * i_in,
                                                        void       * io_out ) {
