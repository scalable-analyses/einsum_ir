...
einsum_ir::err_t einsum_ir::binary::IterationSpace::setup( std::vector< int64_t >   & io_strides_left,
...
void einsum_ir::binary::IterationSpace::convert_strides_to_offsets( std::vector< int64_t > & io_strides) {
