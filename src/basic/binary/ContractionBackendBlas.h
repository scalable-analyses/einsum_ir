#ifndef EINSUM_IR_BASIC_BINARY_CONTRACTION_BACKEND_BLAS
#define EINSUM_IR_BASIC_BINARY_CONTRACTION_BACKEND_BLAS
...
class einsum_ir::basic::ContractionBackendBlas: public ContractionBackend {
  private:
