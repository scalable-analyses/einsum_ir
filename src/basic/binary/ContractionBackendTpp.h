#ifndef EINSUM_IR_BASIC_BINARY_CONTRACTION_BACKEND_TPP
#define EINSUM_IR_BASIC_BINARY_CONTRACTION_BACKEND_TPP
...
class einsum_ir::basic::ContractionBackendTpp: public ContractionBackend {
  private:
