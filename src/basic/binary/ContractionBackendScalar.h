#ifndef EINSUM_IR_BASIC_BINARY_CONTRACTION_BACKEND_SCALAR
#define EINSUM_IR_BASIC_BINARY_CONTRACTION_BACKEND_SCALAR
...
class einsum_ir::basic::ContractionBackendScalar: public ContractionBackend {
  private:
    /**
