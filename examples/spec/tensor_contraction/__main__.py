"""CLI entry: ``python -m examples.spec.tensor_contraction [--backend {tpp,blas}] [--schedule {scalar,gemm,brgemm}] [--show]``."""

from __future__ import annotations

import argparse

from examples.spec.tensor_contraction import DEFAULT_SCHEDULE, SCHEDULES, run


def main() -> None:
    parser = argparse.ArgumentParser(
        description="Run the trus,pqtu->pqrs tensor contraction example.",
    )
    parser.add_argument(
        "--backend",
        default="tpp",
