"""CLI entry: ``python -m examples.spec.permutation [--backend {tpp,blas}] [--name NAME] [--show]``."""

from __future__ import annotations

import argparse

from examples.spec.permutation import ARTIFACTS, DEFAULT_NAME, run


def main() -> None:
    parser = argparse.ArgumentParser(
        description="Run a permutation spec artifact.",
    )
    parser.add_argument(
        "--backend",
        default="tpp",
